...
[![Download APK](https://img.shields.io/badge/Download-SimOS_v1.58.apk-blue?style=for-the-badge&logo=android)](https://github.com/artifexhongkong/simos-scam-simulator/releases/download/v1.58/SimOS_v1.58.apk)

> 所有版本：[Releases 頁面](https://github.com/artifexhongkong/simos-scam-simulator/releases)

### 安裝方式
1. 點擊上方按鈕下載 `SimOS_v1.58.apk`
...
| 版本 | 主要更新 |
|------|----------|
| v1.59 | **黑網 App + 風控系統完善**：Dock「瀏覽器」改名「黑網」、瀏覽器 UI 風格、購買新號碼功能（150 DRC 重置風控 + 新身份）、風控=100 自動推送黑網簡訊 |
| v1.58 | 修正 NPC 角色混淆 |
| v1.57 | 全螢幕 iOS 簡訊介面 + SMS 回覆 + 風控=100 後果 |
| v1.56 | 電信公司簡訊通知系統 |
