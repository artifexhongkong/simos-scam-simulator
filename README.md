...
[![Download APK](https://img.shields.io/badge/Download-SimOS_v1.62.apk-blue?style=for-the-badge&logo=android)](https://github.com/artifexhongkong/simos-scam-simulator/releases/download/v1.62/SimOS_v1.62.apk)

> 所有版本：[Releases 頁面](https://github.com/artifexhongkong/simos-scam-simulator/releases)

### 安裝方式
1. 點擊上方按鈕下載 `SimOS_v1.62.apk`
...
| 版本 | 主要更新 |
|------|----------|
| v1.63 | **電話號碼系統**：購買新號碼只換電話號碼（代號不變）+ 簡訊通知點擊直接進入簡訊詳情頁 |
| v1.62 | 長按刪除好友可點空白取消 |
