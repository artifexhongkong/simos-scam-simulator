...
[![Download APK](https://img.shields.io/badge/Download-SimOS_v1.57.apk-blue?style=for-the-badge&logo=android)](https://github.com/artifexhongkong/simos-scam-simulator/releases/download/v1.57/SimOS_v1.57.apk)

> 所有版本：[Releases 頁面](https://github.com/artifexhongkong/simos-scam-simulator/releases)

### 安裝方式
1. 點擊上方按鈕下載 `SimOS_v1.57.apk`
...
| 版本 | 主要更新 |
|------|----------|
| v1.58 | **修正 NPC 角色混淆**：NPC 不再把玩家當成詐騙犯/推銷對象。系統提示明確定義「你是市民，對方是陌生人」 |
| v1.57 | 全螢幕 iOS 簡訊介面 + SMS 回覆 + 風控=100 後果 |
| v1.56 | 電信公司簡訊通知系統 + Debug 按鈕修正 |
