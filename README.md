...
[![Download APK](https://img.shields.io/badge/Download-SimOS_v1.78.apk-blue?style=for-the-badge&logo=android)](https://github.com/artifexhongkong/simos-scam-simulator/releases/download/v1.78/SimOS_v1.78.apk)

> 所有版本：[Releases 頁面](https://github.com/artifexhongkong/simos-scam-simulator/releases)

### 安裝方式
1. 點擊上方按鈕下載 `SimOS_v1.78.apk`
...
| 版本 | 主要更新 |
|------|----------|
| v1.66 | **成功後保留輸入框**（可繼續詐騙，不需按重置）+ 「查看結果」改為聊天內可點擊訊息（不佔輸入框空間） |
| v1.65 | 多次詐騙同一 NPC + 玩家可開具體金額 + Debug 浮窗不可選取 |
| v1.64 | 移除簡訊「代號維持不變」+ 修復 Debug 文字選取 |
| v1.63 | 電話號碼系統 + 簡訊通知直接進入詳情頁 |
| v1.62 | 長按刪除好友可點空白取消 |
| v1.61 | 修復長按刪除好友 bug |
| v1.60 | 長按刪除好友 + 新號碼 350 DRC + 看廣告免費 |
| v1.59 | 黑網 App + 風控系統完善 |
| v1.58 | 修正 NPC 角色混淆 |
